...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        orders.setPayStatus(Orders.PAID); // 跳过支付流程，直接设置为已支付
    ...
    //查询订单详情
    //用户端订单分页查询
    public PageResult<Orders> pageQuery4User(int pageNum, int pageSize, Integer status) {
        // 设置分页
        ...
        return new PageResult<Orders>(page.getTotal(), list);
    }
    ...
    public PageResult<Orders> conditionSearch(OrdersPageQueryDTO ordersPageQueryDTO) {
        ...
        return new PageResult<Orders>(page.getTotal(), orderVOList);
    }
